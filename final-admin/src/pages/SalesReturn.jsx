...
{/* ================================================ */}
  ...
  <div className="card shadow-lg p-4">
    <h4 className="mb-4">Sales Return</h4>
      ...
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <div className="mb-3">
            ...
            <input type="number" className="form-control" placeholder="Enter return quantity" />
          </div>
        </div>
        ...
        <div className="col-md-6">
          ...
          <div className="mb-3">
            ...
            <input type="number" className="form-control" placeholder="Price per unit" />
          </div>
          ...
          <div className="mb-3">
            ...
            <textarea className="form-control" rows={3} placeholder="Explain reason for return" />
          </div>
        </div>
      </div>
