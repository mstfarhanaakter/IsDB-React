...
{/* ================================================ */}
  ...
  <div className="card shadow-lg p-4">
    <h4 className="mb-4">Manage Sales Returns</h4>

    {/* Filter/Search Section */}
    <div className="row mb-3">
      <div className="col-md-4">
        <input type="text" className="form-control" placeholder="Search by Customer or Invoice No..." />
      </div>
    ...
    <div className="table-responsive">
      <table className="table table-striped table-bordered">
        ...
        <tbody>
          ...
          {/* Map more rows dynamically here */}
        </tbody>
      </table>
    </div>
  </div>
