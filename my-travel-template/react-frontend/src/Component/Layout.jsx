...
<main className="main" id="top">
  <nav className="navbar navbar-expand-lg navbar-light bg-transparent blur-navbar fixed-top py-4 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
    <div className="container"><a className="navbar-brand" href="index"><img src="/src/assets/assets/img/logo.svg" height={34} alt="logo" /></a>
  ...
  <section style={{paddingTop: '7rem'}}>
    <div className="bg-holder" style={{backgroundImage: 'url(/src/assets/assets/img/hero/hero-bg.svg)'}}>
    </div>
    {/*/.bg-holder*/}
    <div className="container">
      <div className="row align-items-center">
        <div className="col-md-5 col-lg-6 order-0 order-md-1 text-end"><img className="pt-7 pt-md-0 hero-img" src="/src/assets/assets/img/hero/hero-img.png" alt="hero-header" /></div>
        <div className="col-md-7 col-lg-6 text-md-start text-center py-6">
          ...
          <div className="text-center text-md-start"> <a className="btn btn-primary btn-lg me-md-4 mb-3 mb-md-0 border-0 primary-btn-shadow" href="#!" role="button">Find out more</a>
            <div className="w-100 d-block d-md-none" /><a href="#!" role="button" data-bs-toggle="modal" data-bs-target="#popupVideo"><span className="btn btn-danger round-btn-lg rounded-circle me-3 danger-btn-shadow"> <img src="/src/assets/assets/img/hero/play.svg" width={15} alt="paly" /></span></a><span className="fw-medium">Play Demo</span>
            <div className="modal fade" id="popupVideo" tabIndex={-1} aria-labelledby="popupVideo" aria-hidden="true">
              <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content">
                  <iframe className="rounded" style={{width: '100%', maxHeight: 500}} height="500px" src="https://www.youtube.com/embed/vEk4c_Nt3ck?si=a9Hq2MUtkjKP7c-E" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen="allowfullscreen" />
  ...
  <section className="pt-5 pt-md-9" id="service">
    <div className="container">
      <div className="position-absolute z-index--1 end-0 d-none d-lg-block"><img src="/src/assets/assets/img/category/shape.svg" style={{maxWidth: 200}} alt="service" /></div>
      ...
      <div className="row">
        <div className="col-lg-3 col-sm-6 mb-6">
          <div className="card service-card shadow-hover rounded-3 text-center align-items-center">
            <div className="card-body p-xxl-5 p-4"> <img src="/src/assets/assets/img/category/icon1.png" width={75} alt="Service" />
        ...
        <div className="col-lg-3 col-sm-6 mb-6">
          <div className="card service-card shadow-hover rounded-3 text-center align-items-center">
            <div className="card-body p-xxl-5 p-4"> <img src="/src/assets/assets/img/category/icon2.png" width={75} alt="Service" />
        ...
        <div className="col-lg-3 col-sm-6 mb-6">
          <div className="card service-card shadow-hover rounded-3 text-center align-items-center">
            <div className="card-body p-xxl-5 p-4"> <img src="/src/assets/assets/img/category/icon3.png" width={75} alt="Service" />
        ...
        <div className="col-lg-3 col-sm-6 mb-6">
          <div className="card service-card shadow-hover rounded-3 text-center align-items-center">
            <div className="card-body p-xxl-5 p-4"> <img src="/src/assets/assets/img/category/icon4.png" width={75} alt="Service" />
  ...
  <section className="pt-5" id="destination">
    <div className="container">
      <div className="position-absolute start-100 bottom-0 translate-middle-x d-none d-xl-block ms-xl-n4"><img src="/src/assets/assets/img/dest/shape.svg" alt="destination" /></div>
      <div className="mb-7 text-center">
      ...
      <div className="row">
        <div className="col-md-4 mb-4">
          <div className="card overflow-hidden shadow"> <img className="card-img-top" src="/src/assets/assets/img/dest/dest1.jpg" alt="Rome, Italty" />
            <div className="card-body py-4 px-3">
              ...
              <div className="d-flex align-items-center"> <img src="/src/assets/assets/img/dest/navigation.svg" style={{marginRight: 14}} width={20} alt="navigation" /><span className="fs-0 fw-medium">10 Days Trip</span></div>
            </div>
          </div>
        </div>
        <div className="col-md-4 mb-4">
          <div className="card overflow-hidden shadow"> <img className="card-img-top" src="/src/assets/assets/img/dest/dest2.jpg" alt="London, UK" />
            <div className="card-body py-4 px-3">
              <div className="d-flex flex-column flex-lg-row justify-content-between mb-3">
              ...
              <div className="d-flex align-items-center"> <img src="/src/assets/assets/img/dest/navigation.svg" style={{marginRight: 14}} width={20} alt="navigation" /><span className="fs-0 fw-medium">12 Days Trip</span></div>
            </div>
          </div>
        </div>
        <div className="col-md-4 mb-4">
          <div className="card overflow-hidden shadow"> <img className="card-img-top" src="/src/assets/assets/img/dest/dest3.jpg" alt="Full Europe" />
            <div className="card-body py-4 px-3">
              <div className="d-flex flex-column flex-lg-row justify-content-between mb-3">
              ...
              <div className="d-flex align-items-center"> <img src="/src/assets/assets/img/dest/navigation.svg" style={{marginRight: 14}} width={20} alt="navigation" /><span className="fs-0 fw-medium">28 Days Trip</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="row align-items-center">
        <div className="col-lg-6">
          ...
          <div className="d-flex align-items-start mb-5">
            <div className="bg-primary me-sm-4 me-3 p-3" style={{borderRadius: 13}}> <img src="/src/assets/assets/img/steps/selection.svg" width={22} alt="steps" /></div>
          ...
          <div className="d-flex align-items-start mb-5">
            <div className="bg-danger me-sm-4 me-3 p-3" style={{borderRadius: 13}}> <img src="/src/assets/assets/img/steps/water-sport.svg" width={22} alt="steps" /></div>
            <div className="flex-1">
          ...
          <div className="d-flex align-items-start mb-5">
            <div className="bg-info me-sm-4 me-3 p-3" style={{borderRadius: 13}}> <img src="/src/assets/assets/img/steps/taxi.svg" width={22} alt="steps" /></div>
            <div className="flex-1">
        ...
        <div className="col-lg-6 d-flex justify-content-center align-items-start">
          <div className="card position-relative shadow" style={{maxWidth: 370}}>
            <div className="position-absolute z-index--1 me-10 me-xxl-0" style={{right: '-160px', top: '-210px'}}> <img src="/src/assets/assets/img/steps/bg.png" style={{maxWidth: 550}} alt="shape" /></div>
            <div className="card-body p-3"> <img className="mb-4 mt-2 rounded-2 w-100" src="/src/assets/assets/img/steps/booking-img.jpg" alt="booking" />
              <div>
                <h5 className="fw-medium">Trip To Greece</h5>
                <p className="fs--1 mb-3 fw-medium">14-29 June | by Robbin joseph</p>
                <div className="icon-group mb-4"> <span className="btn icon-item"> <img src="/src/assets/assets/img/steps/leaf.svg" alt /></span><span className="btn icon-item"> <img src="/src/assets/assets/img/steps/map.svg" alt /></span><span className="btn icon-item"> <img src="/src/assets/assets/img/steps/send.svg" alt /></span>
                </div>
                <div className="d-flex align-items-center justify-content-between">
                  <div className="d-flex align-items-center mt-n1"><img className="me-3" src="/src/assets/assets/img/steps/building.svg" width={18} alt="building" /><span className="fs--1 fw-medium">24 people going</span></div>
                  <div className="show-onhover position-relative">
                    <div className="card hideEl shadow position-absolute end-0 start-xl-50 bottom-100 translate-xl-middle-x ms-3" style={{width: 260, borderRadius: 18}}>
                      <div className="card-body py-3">
                        <div className="d-flex">
                          <div style={{marginRight: 10}}> <img className="rounded-circle" src="/src/assets/assets/img/steps/favorite-placeholder.png" width={50} alt="favorite" /></div>
                          <div>
                    ...
                    <button className="btn"> <img src="/src/assets/assets/img/steps/heart.svg" width={20} alt="step" /></button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="pe-7 ps-5 ps-lg-0">
            <div className="carousel slide carousel-fade position-static" id="testimonialIndicator" data-bs-ride="carousel">
              ...
              <div className="carousel-inner">
                <div className="carousel-item position-relative active">
                  <div className="card shadow" style={{borderRadius: 10}}>
                    <div className="position-absolute start-0 top-0 translate-middle"> <img className="rounded-circle fit-cover" src="/src/assets/assets/img/testimonial/author.png" height={65} width={65} alt /></div>
                ...
                <div className="carousel-item position-relative ">
                  <div className="card shadow" style={{borderRadius: 10}}>
                    <div className="position-absolute start-0 top-0 translate-middle"> <img className="rounded-circle fit-cover" src="/src/assets/assets/img/testimonial/author2.png" height={65} width={65} alt /></div>
                    <div className="card-body p-4">
                ...
                <div className="carousel-item position-relative ">
                  <div className="card shadow" style={{borderRadius: 10}}>
                    <div className="position-absolute start-0 top-0 translate-middle"> <img className="rounded-circle fit-cover" src="/src/assets/assets/img/testimonial/author3.png" height={65} width={65} alt /></div>
                    <div className="card-body p-4">
                      <p className="fw-medium mb-4">"On the Windows talking painted pasture yet its express parties use. Sure last upon he same as knew next. Of believed or diverted no."</p>
              ...
              <div className="carousel-navigation d-flex flex-column flex-between-center position-absolute end-0 top-lg-50 bottom-0 translate-middle-y z-index-1 me-3 me-lg-0" style={{height: 60, width: 20}}>
                <button className="carousel-control-prev position-static" type="button" data-bs-target="#testimonialIndicator" data-bs-slide="prev"><img src="/src/assets/assets/img/icons/up.svg" width={16} alt="icon" /></button>
                <button className="carousel-control-next position-static" type="button" data-bs-target="#testimonialIndicator" data-bs-slide="next"><img src="/src/assets/assets/img/icons/down.svg" width={16} alt="icon" /></button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="row row-cols-lg-5 row-cols-md-3 row-cols-2 flex-center">
        <div className="col">
          <div className="card shadow-hover mb-4" style={{borderRadius: 10}}>
            <div className="card-body text-center"> <img className="img-fluid" src="/src/assets/assets/img/partner/1.png" alt /></div>
          </div>
        </div>
        <div className="col">
          <div className="card shadow-hover mb-4" style={{borderRadius: 10}}>
            <div className="card-body text-center"> <img className="img-fluid" src="/src/assets/assets/img/partner/2.png" alt /></div>
          </div>
        </div>
        <div className="col">
          <div className="card shadow-hover mb-4" style={{borderRadius: 10}}>
            <div className="card-body text-center"> <img className="img-fluid" src="/src/assets/assets/img/partner/3.png" alt /></div>
          </div>
        </div>
        <div className="col">
          <div className="card shadow-hover mb-4" style={{borderRadius: 10}}>
            <div className="card-body text-center"> <img className="img-fluid" src="/src/assets/assets/img/partner/4.png" alt /></div>
          </div>
        </div>
        <div className="col">
          <div className="card shadow-hover mb-4" style={{borderRadius: 10}}>
            <div className="card-body text-center"> <img className="img-fluid" src="/src/assets/assets/img/partner/5.png" alt /></div>
          </div>
        </div>
      </div>
    </div>
  ...
  <section className="pt-6">
    <div className="container">
      <div className="py-8 px-5 position-relative text-center" style={{backgroundColor: 'rgba(223, 215, 249, 0.199)', borderRadius: '129px 20px 20px 20px'}}>
        <div className="position-absolute start-100 top-0 translate-middle ms-md-n3 ms-n4 mt-3"> <img src="/src/assets/assets/img/cta/send.png" style={{maxWidth: 70}} alt="send icon" /></div>
        <div className="position-absolute end-0 top-0 z-index--1"> <img src="/src/assets/assets/img/cta/shape-bg2.png" width={264} alt="cta shape" /></div>
        <div className="position-absolute start-0 bottom-0 ms-3 z-index--1 d-none d-sm-block"> <img src="/src/assets/assets/img/cta/shape-bg1.png" style={{maxWidth: 340}} alt="cta shape" /></div>
            ...
            <form className="row g-3 align-items-center w-lg-75 mx-auto">
              <div className="col-sm">
                <div className="input-group-icon">
                  <input className="form-control form-little-squirrel-control" type="email" placeholder="Enter email " aria-label="email" /><img className="input-box-icon" src="/src/assets/assets/img/cta/mail.svg" width={17} alt="mail" />
                </div>
              </div>
  ...
  <section className="pb-0 pb-lg-4">
    <div className="container">
      <div className="row">
        <div className="col-lg-3 col-md-7 col-12 mb-4 mb-md-6 mb-lg-0 order-0"> <img className="mb-4" src="/src/assets/assets/img/logo2.svg" width={150} alt="jadoo" />
        ...
        <div className="col-lg-3 col-md-5 col-12 mb-4 mb-md-6 mb-lg-0 order-lg-4 order-md-1">
          ...
          <div className="d-flex align-items-center"> <a href="#!"> <img className="me-2" src="/src/assets/assets/img/play-store.png" alt="play store" /></a><a href="#!"> <img src="/src/assets/assets/img/apple-store.png" alt="apple store" /></a></div>
        </div>
      </div>
    </div>{/* end of .container*/}
  </section>
