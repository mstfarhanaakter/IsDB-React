...
{/* ================================================ */}
  ...
  <div className="card shadow-lg p-4">
    <h4 className="mb-4">New Purchase Return</h4>
    ...
    <form>
      <div className="row">
        ...
        <div className="col-md-6">
          ...
          <div className="mb-3">
            ...
            <input type="number" className="form-control" placeholder="Enter quantity to return" />
          </div>
        ...
        <div className="col-md-6">
          {/* Total Refund */}
          <div className="mb-3">
            <label className="form-label">Total Refund (৳)</label>
            <input type="number" className="form-control" placeholder="Auto calculated" readOnly />
          </div>
      ...
      {/* Submit Button */}
      <button type="submit" className="btn btn-primary w-100 mt-3">Confirm Return</button>
    </form>
  </div>
</div>
